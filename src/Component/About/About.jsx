...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | BestBuy4uBD</title>
        <meta name="description" content="Learn about BestBuy4uBD, our mission, values, and commitment to providing quality products and excellent service." />
        <meta name="keywords" content="about us, company info, mission, values" />
      </Helmet>
