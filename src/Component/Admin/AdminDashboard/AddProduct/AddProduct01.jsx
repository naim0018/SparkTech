    ...
    try {
      const productData = {
        basicInfo: {
          ...
          keyFeatures: data.basicInfo.keyFeatures.filter(
        ...
        addDeliveryCharge: data.addDeliveryCharge,
        deliveryChargeInsideDhaka: Number(data.deliveryChargeInsideDhaka),
        deliveryChargeOutsideDhaka: Number(data.deliveryChargeOutsideDhaka),
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Add new products to your store. Enter product details, images, variants, and more."
        />
        <meta
          name="keywords"
          content="add product, product management, admin"
        />
      </Helmet>
      <div
